...
(function (b) {
    ...
    b(function () {
        ...
        b('[data-trigger="sparkline"]').each(function () {
            var a = b(this);
            a.sparkline("html", {
                type: a.data("type"), barColor: a.data("color"), barWidth: a.data("width"), height: a.data("height"),
                values: a.data("value")
            })
        });
        ...
        (a = document.getElementById("morrisLineChart01")) && new Morris.Line({
            element: a.id,
            data: [{degree: "30.05", a: 46}, {degree: "31.05", a: 46}, {degree: "01.06", a: 42}, {
                degree: "02.06",
                a: 50
            }, {degree: "03.06", a: 22}, {degree: "04.06", a: 46}, {degree: "05.06", a: 52}],
            xkey: "degree",
            ykeys: ["a"],
            labels: ["Progress"],
            lineColors: ["#009378"],
        ...
        (a = document.getElementById("morrisLineChart02")) && new Morris.Line({
            element: a.id,
            data: [{month: "Feb", a: 270, b: 250}, {month: "Mar", a: 275, b: 260}, {
                month: "Apr",
                a: 225,
                b: 240
            }, {month: "May", a: 230, b: 230}, {month: "Jun", a: 335, b: 220}],
            xkey: "month",
            ykeys: ["a", "b"],
        ...
        (a = document.getElementById("morrisLineChart03")) && new Morris.Line({
            element: a.id,
            data: [{day: "S", a: 20}, {day: "M", a: 30}, {day: "T", a: 40}, {day: "W", a: 20}, {
                day: "T",
                a: 10
            }, {day: "F", a: 10}, {day: "S", a: 5}],
            xkey: "day",
            ykeys: ["a"],
            labels: ["Overdue"],
            lineColors: ["#e16123"],
        ...
        (a = document.getElementById("morrisAreaChart01")) && new Morris.Area({
            element: a.id,
            data: [{month: "Jan", a: 0, b: 0, c: 500, d: 0}, {
                month: "Feb",
                a: 2E3, b: 1500, c: 500, d: 1E3
                ...
                c: 3E3,
                d: 1500
            }, {month: "Nov", a: 3500, b: 2E3, c: 2E3, d: 3500}, {month: "Dec", a: 5E3, b: 1200, c: 4500, d: 4500}],
            xkey: "month",
            ykeys: ["a", "b", "c", "d"],
        ...
        (a = document.getElementById("morrisAreaChart02")) && new Morris.Area({
            element: a.id,
            data: [{day: "20", a: 0, b: 50}, {day: "21", a: 200, b: 250}, {day: "22", a: 380, b: 250}, {
                day: "23",
                a: 400,
                b: 450
            }, {day: "24", a: 790, b: 350}, {day: "25", a: 600, b: 650}, {day: "26", a: 800, b: 850}],
            xkey: "day",
            ykeys: ["a", "b"],
        ...
        (a = document.getElementById("morrisAreaChart03")) && new Morris.Area({
            element: a.id,
            data: [{month: "Jan", a: 0, b: 0, c: 0, d: 0}, {month: "Feb", a: 1200, b: 0, c: 0, d: 0}, {
                month: "Mar",
                a: 0,
                b: 700,
                c: 0,
                d: 0
            }, {month: "Apr", a: 0, b: 0, c: 1800, d: 0}, {month: "May", a: 0, b: 0, c: 0, d: 1200}, {
                month: "Jun",
                a: 0,
                b: 700,
                c: 0,
                d: 0
            }, {month: "Jul", a: 0, b: 0, c: 0, d: 0}, {month: "Aug", a: 0, b: 0, c: 1200, d: 0}, {
                month: "Sep",
                a: 0,
                b: 0,
                c: 0,
                ...
                month: "Oct", a: 0,
                b: 1200, c: 0, d: 0
            }, {month: "Nov", a: 0, b: 0, c: 0, d: 2400}, {month: "Dec", a: 0, b: 0, c: 0, d: 0}],
            xkey: "month",
            ykeys: ["a", "b", "c", "d"],
        ...
        d.length && (d.validate({
            errorPlacement: function () {
                return !1
            }, rules: {cpassword: {equalTo: "#password"}}
        }), d.steps({
            headerTag: "h3",
            bodyTag: "section",
        ...
        e.length && (e.DataTable({
            responsive: !0,
            language: {lengthMenu: "View _MENU_ records"},
